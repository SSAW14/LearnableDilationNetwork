...
class DataTransformer {
 public:
  ...
  void TransformImgDepthAndSeg(const std::vector<cv::Mat>& cv_img_seg,
    Blob<Dtype>* transformed_data_blob, Blob<Dtype>* transformed_depth_blob, Blob<Dtype>* transformed_label_blob,
    const int ignore_label);
